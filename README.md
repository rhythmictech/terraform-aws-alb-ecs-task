...
| <a name="input_host_headers"></a> [host\_headers](#input\_host\_headers) | The hostname in the request which acts as condition for listener. See<br>https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule#host_header | `list(string)` | n/a | yes |
